...
`;this.render(A)}async selectLang(A){console.log("Selecting language",A),window.preferredLanguage=A,localStorage.setItem("preferredLanguage",A),window.goHome()}}export{M as default};
