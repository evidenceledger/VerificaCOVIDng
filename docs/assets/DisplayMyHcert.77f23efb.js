import{l as d}from"./w3full.5148bcf4.js";import{r as n,A as c}from"./AbstractPage.2d6cb208.js";import{C as h,v as g,o as m,w as v,e as u}from"./warning.82a7012e.js";import"./_commonjsHelpers.4e997714.js";n("DisplayMyHcert",class extends c{constructor(t){super(t)}async enter(t){let i=this.html;if(t=window.localStorage.getItem("MYEUDCC"),t==null){this.render(i`
            <div id="hcertFailed" class="w3-panel bkg-fail">
                <h2>${T("There is no certificate.")}</h2>
            </div>
            `);return}let a,r=!1,l="";try{a=await h.decodeHC1QR(t,!0),r=a[3]}catch(s){d.myerror("Error verifying credential",s),this.render(this.renderGeneralError(s));return}let e={result:"OK",message:T("The certificate is valid.")};r===!1?(e.result="ERROR",e.message=T("Signature validation failed. The certificate is not valid.")):r==="PRE"&&(e.result="WARNING",e.message=T("$warningmsg")),console.log(e),(r===!0||r==="PRE")&&(console.log("Additional verifications"),r=g(a),console.log(r),r!=!0&&(e.result="ERROR",e.message=T(r))),console.log(e);try{l=this.renderDetail(a,e)}catch(s){d.myerror("Error rendering credential",s),this.render(this.renderGeneralError(s));return}let o=i`
        ${l}
