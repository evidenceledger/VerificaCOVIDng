import{l as n}from"./app.067879c9.js";import{r as o,A as c}from"./AbstractPage.18a62ded.js";import{C as h,v as g,o as m,w as v,e as u}from"./warning.06d28193.js";import"./_commonjsHelpers.b8add541.js";o("DisplayMyHcert",class extends c{constructor(i){super(i)}async enter(i){let t=this.html;if(i=window.localStorage.getItem("MYEUDCC"),i==null){this.render(t`
        ...
        `;this.render(d)}renderGeneralError(i){return this.html`
            ...
            `}renderDetail(i,t){let a=this.html,r=i[1],s="Validated",e=m,d="bkg-success";return t.result==="WARNING"?(s="Warning",e=v,d="bkg-warning"):t.result==="ERROR"&&(s="Not Validated",e=u,d="bkg-error"),a`
            <div class="container">
