import{r as i,A as l}from"./AbstractPage.7cdc723e.js";import{a as c}from"./camerainfo.4311a7fd.js";import"./w3full.ca34ba64.js";i("SelectCamera",class extends l{constructor(e){super(e)}async enter(){let e=this.html;try{var r=await c();if(r.videoDevices.length==0){this.render(e`<p>No camera available</p>`);return}var t=r.videoDevices}catch{this.render(e`<p>No camera available</p>`);return}let s=e`
