import{r as i,A as l}from"./app.2013b920.js";import"./vendor.f8864ac5.js";i("Faqs",class extends l{constructor(a){super(a)}toggleFaqs(a){document.getElementById(a).classList.toggle("show")}hideFaqs(){document.getElementById("faqsitem").classList.remove("show")}async enter(){let s=this.html`
