import{A as s}from"./index.90173e4d.js";import{h as i}from"./vendor.f8864ac5.js";class n extends s{constructor(a){super("Faqs")}toggleFaqs(a){document.getElementById(a).classList.toggle("show")}hideFaqs(){document.getElementById("faqsitem").classList.remove("show")}async enter(){let a=i`
