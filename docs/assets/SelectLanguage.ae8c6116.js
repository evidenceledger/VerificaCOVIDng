    ...
    <ul>
        ...
        <li class="mx-4 my-2 shadow-md">
            <a @click=${()=>this.selectLang("it")} href="javascript:void(0)">
                <div class="flex p-2">
                    <img class="mr-4" src=${h} style="width:70px;height:45px">
...
`;this.render(A)}async selectLang(A){console.log("Selecting language",A),window.preferredLanguage=A,localStorage.setItem("preferredLanguage",A),window.goHome()}}new d;export{d as default};
