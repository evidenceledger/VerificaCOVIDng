var D=Object.defineProperty;var N=(n,e,t)=>e in n?D(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var d=(n,e,t)=>(N(n,typeof e!="symbol"?e+"":e,t),t);import{g as y,_ as B,l as w}from"./app.0ab7b43d.js";import{r as L,A as O,h as E}from"./AbstractPage.5982b473.js";import{g as V,a as F}from"./camerainfo.4311a7fd.js";const C=0,x=1,G=2,W=3;L("ScanQrNativePage",class extends O{constructor(e){super(e);d(this,"displayPage");d(this,"detectionInterval",200);d(this,"videoElement");d(this,"nativeBarcodeDetector");d(this,"jsQR");d(this,"lastUsedCameraId");d(this,"canvasElement");d(this,"canvasSpace");"BarcodeDetector"in window?(console.log("Barcode Detector supported!"),this.nativeBarcodeDetector=new BarcodeDetector({formats:["qr_code"]})):(console.log("Barcode Detector is not supported by this browser."),this.jsQRPromise=B(()=>import("./jsQR.3d2f64bb.js").then(function(t){return t.j}),["assets/jsQR.3d2f64bb.js","assets/_commonjsHelpers.b8add541.js"])),this.videoElement={},this.canvasElement=document.createElement("canvas"),this.canvasSpace=this.canvasElement.getContext("2d")}async enter(e){if(e||(e="DisplayHcert"),this.displayPage=e,!this.nativeBarcodeDetector){let a=await this.jsQRPromise;this.jsQR=a.default}this.lastUsedCameraId=await this.selectCamera();let t=E`
