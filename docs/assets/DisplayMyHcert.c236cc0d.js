import{l as o}from"./w3full.ca34ba64.js";import{r as n,A as c}from"./AbstractPage.7cdc723e.js";import{C as h,v as g,o as m,w as v,e as u}from"./warning.1bbc81a1.js";import"./_commonjsHelpers.b8add541.js";n("DisplayMyHcert",class extends c{constructor(t){super(t)}async enter(t){let i=this.html;if(t=window.localStorage.getItem("MYEUDCC"),t==null){this.render(i`
        ...
        `;this.render(d)}renderGeneralError(t){return this.html`
            ...
            `}renderDetail(t,i){let a=this.html,r=t[1],l="Validated",e=m,d="bkg-success";return i.result==="WARNING"?(l="Warning",e=v,d="bkg-warning"):i.result==="ERROR"&&(l="Not Validated",e=u,d="bkg-error"),a`
            <div class="container">
